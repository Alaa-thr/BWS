...
@section('content')
  ...
  ****************************************************************************************************-->
  	<!-- Modal1 -->
    <div class="wrap-modal1 js-modal1 p-t-40 p-b-20 p-l-15 p-r-15" id="cmd">
      <div class="overlay-modal1 js-hide-modal1"></div>
  
      <div class="container" style=" margin-top: 125px; margin-right: 25px;">
        <div class="bg0 p-t-45 p-b-100 p-lr-15-lg how-pos3-parent">
          <button class="how-pos3 hov3 trans-04 p-t-6 js-hide-modal1">
		  <i class="zmdi zmdi-close" style="margin-top: -655px;"></i>
		</button>
