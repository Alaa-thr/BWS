          ...
          <form  action="/abestaa" method="get">
            ...
            <li class="nav-item dropdown" style="cursor: pointer; margin-right: 40px;">
                <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <img class="img-xs rounded-circle" src=" <?php echo e(asset('storage/profil_image/'.$admin[0]->image)); ?>" alt="..."  />
                  <p>
                        ...
                        <a >
                          <table >
                            <tr>
                              <td width="50%">
                                  <a href="#">
                                  <img class="img-lg rounded-circle"  src=" <?php echo e(asset('storage/profil_image/'.$admin[0]->image)); ?>" alt="..."> 
                              </a>
                              </td>
                              <td>
                                   <h6 class="description text-left" ><b id="a"><?php echo e($a->nom); ?> <?php echo e($a->prenom); ?></b></h6>
                                   <a href ="<?php echo e($a->email); ?>" id ="nab"><?php echo e($a->email); ?></a>
                               </td>
                             </tr>
                            </table>
                        </a>  
...
</html><?php /**PATH C:\xampp\htdocs\BWS\resources\views/admin_admin.blade.php ENDPATH**/ ?>