...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group flex-t m-b-35">
                    ...
                    <select class="form-control form-control-lg" id="exampleFormControlSelect1"  name="compte">
                        <option selected>Connecte tenque</option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\try\resources\views/auth/register.blade.php ENDPATH**/ ?>