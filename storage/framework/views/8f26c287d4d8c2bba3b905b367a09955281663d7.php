...
<?php $__env->startSection('content'); ?>
   ...
   <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
      ...
      <form  action="/categorieShopS" method="get" id="sbmt" name='sbmt'>
                ...
                <div class="col-md-12" style=" display: inline-flex;">
                  ...
                  <div class=" col-md-9" style="display: inline-flex;">
                    <div class="col-md-5">
                      ...
                      <option value="0"  disabled>Choisie le type de Categories :</option>
                      <option value="shopCategories" selected>Shop Categories</option>
                  ...
                  <div class="col-md-8 ">
                    <div class="form-group col-md-13">
                      ...
                      <div style="display: inline-flex; margin-top: 10px;">
                        ...
                        <select v-if="edit === true" class="form-control" id="typeCategorie" name ="typeCategorie" @change="SavetTypeCategorie($event)" :class="{'is-invalid' : message.typeCategorie}" style="margin-right: 20px; height: 38px;">
                        <option value="0"  disabled selected>Choisie le type de Categories :</option>
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
          <?php
           ...
           ?>
           <div class="row"  v-if="categories.length == 0 && '<?php echo $url?>'.includes('categorieShopS') == true">
             <div  class="col-md-12" >
              <div class="card">
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->      
        <div class="row" style="margin-top: 20px;" v-for="c in categories">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <table width="100%" id="c.id" v-if="categories.length != 0">
                  <tr>
                    <td style=" width: 4%;">  
                        <div v-if="selectall">
  ...
  var app = new Vue({
    ...
    methods: {
      ...
      getCategories:function(){
             axios.get(window.Laravel.url+'/shopCategories')
             .then(response => {
                  this.categories = window.Laravel.categoShop.data;
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.template_admin_categories', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BWS\resources\views/shop_categorie_admin.blade.php ENDPATH**/ ?>