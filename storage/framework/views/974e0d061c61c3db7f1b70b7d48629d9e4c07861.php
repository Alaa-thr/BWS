                ...
                <div class="row  col-md-12 ">
                  <div class=" col-md-12 flex-t" >
                    <div class="col-md-6 flex-t" v-if="selectall" >
                      ...
                      <img data-toggle="tooltip" title="Vous avez accepté cette commande" v-if='commandec.response == 0' src="<?php echo e(asset('images/correct.png')); ?>" style="height: 20px; width: 20px; cursor: pointer;" class="m-t-5 m-l-5"/>
                      <img data-toggle="tooltip" title="Vous avez refusé cette commande"v-else src="<?php echo e(asset('images/incorrect.png')); ?>" style="height: 32px; width: 25px; cursor: pointer;" class=" m-l-5"/>
                    </div>
        ...
        <div class="bg0 p-t-45 p-b-100 p-lr-15-lg how-pos3-parent col-md-12" >
          ...
          <div class="p-b-30 p-l-40" >
            <h4 class="ltext-102  cl2">
                     COMMANDE DE    {{client.nom_client.toUpperCase()}} {{client.prenom_client.toUpperCase()}} <img data-toggle="tooltip" title="Vous avez accepté cette commande" v-if='client.Réponse_vendeur == 0' src="<?php echo e(asset('images/correct.png')); ?>" style="height: 40px; width: 40px; cursor: pointer;" class="m-l-5"/>
                      <img data-toggle="tooltip" title="Vous avez refusé cette commande"v-else src="<?php echo e(asset('images/incorrect.png')); ?>" style="height: 65px; width: 50px; cursor: pointer;" class="m-l-5"/>
