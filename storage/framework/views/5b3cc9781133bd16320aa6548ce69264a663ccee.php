              ...
              <!-- <form style="margin-top: 15px; font-weight: 700;" > -->
                ...
                <div class="row">
                  <div class="col-md-4 pl-2">
                    <div class="form-group">
                      <label>Nom</label>
                      <input name="nom" type="text" class="form-control" v-model="profilclient.nom" value="<?php echo e(old('nom')); ?>" v-on:click="modif = true">
                    </div>
                  </div>
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      <label>Prénom</label>
                      <input name="prenom" type="text" class="form-control" v-model="profilclient.prenom" value="<?php echo e(old('prenom')); ?>" v-on:click="modif = true"> 
                   </div>
                 </div>
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      <label>Numero Telephone</label>
                      <input name="num_telephone" type="text" class="form-control" v-model="profilclient.numeroTelephone" value="<?php echo e(old('numeroTelephone')); ?>" v-on:click="modif = true">
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-8 pl-2">
                    <div class="form-group">
                      ...
                      <input name="adresse_email" type="email" class="form-control" v-model="profilclient.email" value="<?php echo e(old('email')); ?>" v-on:click="modif = true">
                    </div>
                  </div>
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      <label>Code postal</label>
                      <input name="code_postal" type="text" class="form-control" v-model="profilclient.codePostal" value="<?php echo e(old('codePostal')); ?>" v-on:click="modif = true">
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-md-6 pl-2">
                    <div class="form-group">
                      <label >Ville</label>
                      <input name="v" type="text" class="form-control" v-model="profilclient.ville" value="<?php echo e(old('ville')); ?>" v-on:click="modif = true">
                    </div>
                  </div>
