                ...
                <div class="row">
                  <div class="col-md-4 pl-2">
                    <div class="form-group">
                      <label>Nom</label>
                      <input name="nom" type="text" class="form-control" v-model="profilvendeur.Nom" value="<?php echo e(old('Nom')); ?>" v-on:click="modif = true" :class="{'is-invalid' : message.Nom}">
                  ...
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      <label>Prénom</label>
                      <input name="prenom" type="text" class="form-control" v-model="profilvendeur.Prenom" value="<?php echo e(old('Prenom')); ?>" v-on:click="modif = true" :class="{'is-invalid' : message.Prenom}">
                  ...
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      ...
                      <input name="num" type="text" class="form-control" v-model="profilvendeur.numTelephone" value="<?php echo e(old('numTelephone')); ?>" v-on:click="modif = true" :class="{'is-invalid' : message.numTelephone}">
                ...
                <div class="row">
                  <div class="col-md-8 pl-2">
                    <div class="form-group">
                      ...
                      <input name="adresse_email" type="email" class="form-control" v-model="profilvendeur.email" value="<?php echo e(old('email')); ?>" v-on:click="modif = true" :class="{'is-invalid' : message.email}">
                  ...
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      ...
                      <input name="bnq" type="text" class="form-control" v-model="profilvendeur.Num_Compte_Banquaire " value="<?php echo e(old('Num_Compte_Banquaire ')); ?>" v-on:click="modif = true" :class="{'is-invalid' : message.Num_Compte_Banquaire}">
                ...
                <div class="row">
                  <div class="col-md-12 pl-2">
                    <div class="form-group">
                      ...
                      <input name="Addresse" type="text" class="form-control" placeholder="Home Address" v-on:click="modif = true" v-model="profilvendeur.Addresse" value="<?php echo e(old('Addresse')); ?>" :class="{'is-invalid' : message.Addresse}">
                ...
                <div class="row">
                  <div class="col-md-6 pl-2">
                    <div class="form-group">
                      ...
                      <input name="boutique" type="text" class="form-control" v-model="profilvendeur.Nom_boutique" value="<?php echo e(old('Nom_boutique')); ?>" v-on:click="modif = true" :class="{'is-invalid' : message.Nom_boutique}">
...
<?php echo $__env->make('layouts.template_vendeur', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BWS\resources\views/profil_vendeur.blade.php ENDPATH**/ ?>