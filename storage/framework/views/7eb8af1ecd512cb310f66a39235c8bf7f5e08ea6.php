                ...
                <div class="row">
                  <div class="col-md-4 pl-2">
                    <div class="form-group">
                      <label>Nom</label>
                      <input name="nom" type="text" class="form-control" v-model="profiladmin.nom" value="<?php echo e(old('nom')); ?>" v-on:click="modif = true">
                    </div>
                  </div>
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      <label>Prénom</label>
                      <input name="prenom" type="text" class="form-control" v-model="profiladmin.prenom" value="<?php echo e(old('prenom')); ?>" v-on:click="modif = true">
                   </div>
                 </div>
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      <label>Numero Telephone</label>
                      <input name="num" type="" class="form-control" v-model="profiladmin.numTelephone" value="<?php echo e(old('numTelephone')); ?>" v-on:click="modif = true">
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      ...
                      <input name="bnq" type="text" class="form-control" v-model="profiladmin.numCarteBanquaire" value="<?php echo e(old('numCarteBanquaire')); ?>" v-on:click="modif = true">
                    </div>
                  </div>
                </div>
                <div class="row">
