			...
			<div class="wrap-icon-header flex-w flex-r-m m-r-15">
				...
				<div class="dropdown">
                              ...
                              <div class="dropdown-menu m-r-35" aria-labelledby="dropdownMenuButton">
                              	<div href="{{ route('statistiquesVendeur') }}">
                              		<a class="dropdown-item" href="{{ route('statistiquesVendeur') }}" >{{ __('Mon Espace') }}</a>
                              	</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3 p-b-50 m-r-120">
                    ...
                    <ul>
                      <li class="stext-107 cl7 size-201">Des questions, Quelque chose n'est pas bien? Faites-nous savoir sur 05-40-84-47-82, basmah.work_shop@gmail.com ou <a href="{{route('contact')}}" style="color: #148bff;">contact</a>.
