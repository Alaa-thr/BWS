                ...
                <div class="row">
                  <div class="col-md-4 pl-2">
                    <div class="form-group">
                      <label>Nom</label>
                      <input name="nom" type="text" class="form-control" v-model="profilemployeur.nom" value="{{old('nom')}}" v-on:click="modif = true":class="{'is-invalid' : message.nom}">
                  ...
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      <label>Prénom</label>
                      <input name="prenom" type="text" class="form-control" v-model="profilemployeur.prenom" value="{{old('prenom')}}" v-on:click="modif = true":class="{'is-invalid' : message.prenom}">
                  ...
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      ...
                      <input name="num" type="text" class="form-control" v-model="profilemployeur.num_tel" value="{{old('num_tel')}}" v-on:click="modif = true":class="{'is-invalid' : message.num_tel}">
                ...
                <div class="row">
                  <div class="col-md-8 pl-2">
                    <div class="form-group">
                      ...
                      <input name="adresse_email" type="email" class="form-control" v-model="profilemployeur.email" value="{{old('email')}}" v-on:click="modif = true":class="{'is-invalid' : message.email}">
                  ...
                  <div class="col-md-4 pl-1">
                    <div class="form-group">
                      ...
                      <input name="bnq" type="text" class="form-control" v-model="profilemployeur.num_compte_banquiare" value="{{old('num_compte_banquiare')}}" v-on:click="modif = true":class="{'is-invalid' : message.num_compte_banquiare}">
                ...
                <div class="row">
                  <div class="col-md-6 pl-2">
                    <div class="form-group">
                      ...
                      <input name="societe" type="text" class="form-control" v-model="profilemployeur.nom_societe" value="{{old('nom_societe')}}" v-on:click="modif = true":class="{'is-invalid' : message.nom_societe}">
