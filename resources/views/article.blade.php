				...
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="p-b-63" v-for="art in articles">
							<a v-bind:href="{{route('/article_detaillé/' +ar.id)}}" class="hov-img0 how-pos5-parent">
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="{{route('/article_D/' .$ar->id)}}" class="ltext-108 cl2 hov-cl1 trans-04 color-t">
										@{{ art.titre }}
									</a>
								</h4>
								...
								<div class="flex-w flex-sb-m p-t-18">
									...
									<a href="{{route('/article_D/' .$ar->id )}}" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10" style="font-style: italic;">
										Afficher plus
