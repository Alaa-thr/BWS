                      ...
                      <div class="card-body" >
                          ...
                          <div style="margin-top: 30px;">
                           ...
                           <div class="row">
                            ...
                            <div class="author" style="margin-left: 85px; color:black; margin-top: 30px;"><b>@{{ vendeuraa.email }}</b></div>
                          </div>
                          <div class="row" >
                            ...
                            <div  style="margin-left: 120px; color:black; margin-top: 30px; height: 70px;"><b>@{{ vendeuraa.numTelephone }}</b></div>
                          </div>
                      </div>
                    </div>
                  </div>
