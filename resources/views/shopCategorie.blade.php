			...
			<div class="flex-w flex-sb-m p-b-52" id="app122">
				<div class="flex-w flex-c-m m-tb-5">
			        ...
			        <div class="m-l-25 respon6-next" style="width: 230px;">
						<div class="rs1-select2 bor8 bg0" >
							@if(strpos($url, 'couleur')!= FALSE && strpos($url, 'prix')==FALSE && strpos($url, 'taille')==FALSE)
				            	<select class="js-select2"  onchange="window.location.href = this.options[this.selectedIndex].value" >
									...
									@foreach($AllColors as $ACL)
										<option type="submit" value="/shop/search_categorie={{request()->route('id')}}/sous-categorie={{request()->route('id1')}}/couleur=<?php echo($ACL->nom)?>">
											{{$ACL->nom}}
										</option>
									@endforeach
				            ...
				            @elseif(strpos($url, 'couleur')== FALSE && (strpos($url, 'prix')!=FALSE || strpos($url, 'taille')!=FALSE) && (strpos($url, 'ville')!=FALSE || strpos($url, 'type_livraison')!=FALSE))
				            	<select class="js-select2" onchange="window.location.href = this.options[this.selectedIndex].value" >
				                ...
				                <div class="dropDownSelect2"></div>
				            @elseif(strpos($url, 'couleur')!= FALSE  && (strpos($url, 'ville')!=FALSE || strpos($url, 'type_livraison')!=FALSE))
				            	<select class="js-select2" onchange="window.location.href = this.options[this.selectedIndex].value" >
					                <option value="0" disabled selected>Couleur</option>
				            ...
				            @elseif(((strpos($url, 'couleur') && strpos($url, 'prix') && strpos($url, 'taille')) || (strpos($url, 'couleur') && strpos($url, 'prix')) || (strpos($url, 'couleur') && strpos($url, 'taille')))&& (strpos($url, 'ville')==FALSE && strpos($url, 'type_livraison')==FALSE))
				            	<select class="js-select2" onchange="window.location.href = this.options[this.selectedIndex].value" >
					                <option value="0" disabled selected>@{{NameColor}}</option>
						...
						<div class="rs1-select2 bor8 bg0" >
			            	@if(strpos($url, 'couleur')== FALSE && strpos($url, 'prix')==FALSE && strpos($url, 'taille')!=FALSE)
				            	...
				            	<select class="js-select2"  onchange="window.location.href = this.options[this.selectedIndex].value">
					                ...
					                @for ($i = 19; $i <= 50; $i++)
                                            <option value="<?php echo modify_url('taille',$i,request()->route("tail"))?>">&nbsp&nbspPointure {{ $i }}</option>
                                    @endfor
				            ...
				            @elseif(strpos($url, 'taille')== FALSE && (strpos($url, 'prix')!=FALSE || strpos($url, 'couleur')!=FALSE) && (strpos($url, 'ville')!=FALSE || strpos($url, 'type_livraison')!=FALSE))
				            	<select class="js-select2" onchange="window.location.href = this.options[this.selectedIndex].value" >
	                        		...
	                        		<option value="" disabled >Pointure </option>
					                @for ($i = 19; $i <= 50; $i++)
                                            <option value="<?php echo deleteFrom_url('taille',$i)?>">&nbsp&nbspPointure {{ $i }}</option>
                                    @endfor
				            ...
				            @elseif(strpos($url, 'taille')!= FALSE  && (strpos($url, 'ville')!=FALSE || strpos($url, 'type_livraison')!=FALSE))
				                <select class="js-select2" onchange="window.location.href = this.options[this.selectedIndex].value" >
	                        		...
	                        		<option  value="/shop/search_categorie={{request()->route('id')}}/sous-categorie={{request()->route('id1')}}/taille=L">L</option>
	                        		<option  value="/shop/search_categorie={{request()->route('id')}}/sous-categorie={{request()->route('id1')}}/taille=XL">XL</option>
	                        		<option  value="/shop/search_categorie={{request()->route('id')}}/sous-categorie={{request()->route('id1')}}/taille=XXL">XXL</option>
	                        		<option  value="/shop/search_categorie={{request()->route('id')}}/sous-categorie={{request()->route('id1')}}/taille=XXXL">XXXL</option>

	                        		<option value="" disabled >Pointure </option>
					                @for ($i = 19; $i <= 50; $i++)
                                            <option value="/shop/search_categorie={{request()->route('id')}}/sous-categorie={{request()->route('id1')}}/taille=<?php echo $i?>">&nbsp&nbspPointure {{ $i }}</option>
                                    @endfor
						                	
				            	</select>
				                <div class="dropDownSelect2"></div>
				            @elseif(((strpos($url, 'couleur') && strpos($url, 'prix') && strpos($url, 'taille')) || (strpos($url, 'taille') && strpos($url, 'prix')) || (strpos($url, 'couleur') && strpos($url, 'taille')))&& (strpos($url, 'ville')==FALSE && strpos($url, 'type_livraison')==FALSE))
				            	<select class="js-select2"  onchange="window.location.href = this.options[this.selectedIndex].value" >
			                ...
			                @else
			                	<select class="js-select2" onchange="window.location.href += this.options[this.selectedIndex].value" >
	                        		...
	                        		<option value="" disabled >Pointure </option>
					                @for ($i = 19; $i <= 50; $i++)
                                            <option value="/taille=<?php echo $i?>">&nbsp&nbspPointure {{ $i }}</option>
                                    @endfor
					...
					<div class="m-l-25 respon6-next" style="width: 230px;">
						<div class="rs1-select2 bg0" >
				            ...
				            @elseif(strpos($url, 'prix')== FALSE && (strpos($url, 'couleur')!=FALSE || strpos($url, 'taille')!=FALSE) && (strpos($url, 'ville')!=FALSE || strpos($url, 'type_livraison')!=FALSE))
				            ...
				            @elseif(strpos($url, 'prix')!= FALSE  && (strpos($url, 'ville')!=FALSE || strpos($url, 'type_livraison')!=FALSE))
				                <input type="range" id="myRange" min="<?php echo $priceMin ?>" max="<?php echo $priceMax ?>" :value="NamePrix" style="width: 230px;" oninput="updateRange()" onchange="window.location.href= '/shop/search_categorie={{request()->route('id')}}/sous-categorie={{request()->route('id1')}}/prix='+this.value"/>

							@elseif(((strpos($url, 'couleur') && strpos($url, 'prix') && strpos($url, 'taille')) || (strpos($url, 'couleur') && strpos($url, 'prix')) || (strpos($url, 'prix') && strpos($url, 'taille')))&& (strpos($url, 'ville')==FALSE && strpos($url, 'type_livraison')==FALSE))
				            	
				                <input type="range" id="myRange" min="<?php echo $priceMin ?>" max="<?php echo $priceMax ?>" :value="NamePrix" style="width: 230px;" oninput="updateRange()" onchange="window.location.href= updateRange_url(this.value,'{{request()->route('prx')}}')"/>
			    ...
			    <div class="flex-w flex-c-m m-tb-20">
			        ...
			        @if(strpos($url, 'couleur')!= FALSE ||strpos($url, 'taille')!= FALSE  ||strpos($url, 'prix')!= FALSE)
			        <div class="  respon6-next" style="width: 230px;">
						<div class="rs1-select2 bor8 bg0" >
			            	@if(strpos($url, 'type_livraison')!= FALSE)
				            	<select class="js-select2"  onchange="window.location.href = this.options[this.selectedIndex].value" >
			        ...
			        <div class="m-l-25 respon6-next" style="width: 230px;">
						<div class="rs1-select2 bor8 bg0" >
			            	@if(strpos($url, 'ville')!= FALSE)<!--existe-->
				            	<select class="js-select2" onchange="window.location.href = this.options[this.selectedIndex].value" >
									@if(strpos($url, 'ville')!= FALSE)
				            ...
				            @elseif(strpos($url, 'ville')== FALSE)<!-- N'existe pas-->
				            	<select class="js-select2" onchange="window.location.href += this.options[this.selectedIndex].value" >
