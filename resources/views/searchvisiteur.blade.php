          ...
          @if(count($emploi) != 0)
              @foreach($emploi as $emp)
                ...
                <div  class="col-md-4 block2 block2-pic hov-img0">
                  ...
                  <a class="js-show-modal1 block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 " v-on:click="AfficheInfoDemande({{ json_encode($emp->id) }})" style="cursor: pointer;">
                    Quick View
                  </a>
                </div>

                <div class="col-md-6 js-show-modal1"  v-on:click="AfficheInfoDemande({{ json_encode($emp->id) }})" style="cursor: pointer;">
                ...
                <div class="col-md-9 m-l-30 js-show-modal1" v-on:click="AfficheInfoDemande({{ json_encode($emp->id) }})" style="cursor: pointer;">
                  <h5 class="title" style="color: red;" >
                    <b>{{$emp->libellé}}</b>
                  </h5><br>
                ...
                @if($k == 1)
                  <div class="m-t-100" style="float: right;">
                    ...
                    <a  class="" v-on:click="AjoutAuFavorisE({{ json_encode($emp) }})" style="cursor: pointer; " >
