...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
      ...
      <form  action="/categorieEmploiS" method="get" id="sbmt" name='sbmt'>
...
<!--++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++-->
           ...
           @endphp
           <div class="row"  v-if="categories.length == 0 && '<?php echo $url?>'.includes('categorieEmploiS') == true">
             <div  class="col-md-12" >
              <div class="card">
          ...
          <div v-if="AutreExiste && '<?php echo $url?>'.includes('categorieEmploiS') != true" class="row" style="margin-top: 20px;">
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
